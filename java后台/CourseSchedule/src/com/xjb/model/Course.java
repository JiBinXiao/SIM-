...
public class Course {
	...
	public Course(String weekno, String week, String section,
	...
	public String toString() {
		return "Course [weekno=" + weekno + ", week=" + week + ", section="
				+ section + ", courseName=" + courseName + ", classes="
				+ classes + ", num=" + num + ", teacher=" + teacher
				+ ", address=" + address + ", courseType=" + courseType + "]";
	}
